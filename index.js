...
/////////////////
const BotName = 'Zarbot'; 
const instagram = 'https://www.instagram.com/ridwan._.anugrah/'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@ridwan._.anugrah')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@ridwan._.anugrah`)
})
